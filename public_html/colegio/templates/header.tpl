...
<html xmlns="http://www.w3.org/1999/xhtml" lang="pt-br" xml:lang="pt-br">
    <head>
        <title>Colégio Cenecista - {?$title?}</title>
        {?* Meta Tags *?}
        ...
        <div id="marcador">
        <img src="{?$basePATH?}/_img/colegio/marcador.jpg" />
        </div>
        ...
        {?/if?}
        swfobject.embedSWF("http://docs.serverws.com.br/cnecbento.com.br/banners/", "{?$banner.slug?}", "{?$banner.largura?}", "{?$banner.altura?}", "6.0.0", "/_swf/expressInstall.swf", flashvars, params, attributes);
        </script>
        </div>
        {?/foreach?}
        </div>
        ...
        <a href="http://faculdade.cnecbento.com.br">Faculdade</a>
        </div>
        <script type="text/javascript">
        $(function(){
