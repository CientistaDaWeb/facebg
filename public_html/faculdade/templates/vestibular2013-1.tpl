...
<img src="/_img/vestibular/2013/1/hotsite.jpg" />
<style type="text/css">
    #linksCursos a{
        display: block;
        text-indent: -9000px;
...
<div id="linksCursos">
    ...
    <div id="cursos">
        <div class="curso_esquerda">
            <a href="/curso/graduacao/biomedicina" title="Graduação em Biomedicina">Bio Medicina</a>
        ...
        <div class="curso_direita">
            ...
            <a href="/curso/graduacao/ciencias-contabeis" title="Graduação em Ciências Contábeis">Ciências Contábeis</a>
        </div>
    </div>
</div>
