...
{?if $inscricao?}
        ...
        $(document).ready(function(){
            ...
            $("#form_vest_inscr").validate({
                ...
                messages: {
                    ...
                    sexo: msgSelectRadio,
                    escola: msgInput,
                    amigos: msgSelectRadio,
                    comoSoube: msgSelectRadio,
                    visita: msgSelectRadio
                }
            });
    ...
    <div id="topo" class="box">
        ...
        <h3>
            Atenção: Após pagamento do Boleto Bancário, todos os candidatos deverão entregar, na Secretaria da Faculdade, até 18/07/2013: fotocópia da RG (frente e verso) , fotocópia do Comprovante de Conclusão do Ensino Médio, e cópia do boletim de desempenho no ENEM (em caso de aproveitamento da nota para a Redação).
        </h3>
        <!-- Primeiro Formulário -->
        {?if !$cadastro?}
            <form method="post" id="form_vest_inscr" action="/vestibular/inscrever/">
                <div id="passo_1" class="inscricao">
                    ...
                    <ul>
                        ...
                        <li>Somente para participantes do ENEM de 2007 a 2012.</li>
                        <li>Esta documentação deverá ser entregue até 18/07/2013 na Secretaria da Faculdade onde deve ser retirado também o COMPROVANTE DE INSCRIÇÃO.</li>
                    </ul>
                ...
                <div id="passo_2" class="inscricao">
                    ...
                    <p><label for="escola">Escola em que terminou o Ensino Médio:</label></p>
                    <p><input id="escola" title="Escola em que terminou o Ensino Médio" name="escola" type="text" class="inpute" /></p>

                    <p><label for="amigos">Tem amigos (as) que estudam ou já estudaram na CNEC:</label></p>
                    <p><select name="amigos" id="amigos" class="inpute">
                    ...
                    <p><select id="comoSoube" name="comoSoube" class="inpute">
                            ...
                            <option value="adesivo">Adesivo em Carros</option>
                            <option value="amigos">Amigos(as) que indicaram</option>
                            <option value="panfletoPostal">Panfleto Postal</option>
                            <option value="palestra">Palestra na Escola</option>
                            <option value="visita">Visita a Faculdade</option>
                            <option value="divulgacao">Divulgacao na Empresa onde Trabalha</option>
                    ...
                    <p><label for="visita">Participou de visita aos laboratórios (anatomia, TV, fotografia, enfermagem, etc.) da CNEC com a sua escola durante o Ensino Médio?</label></p>
                    <p><select name="visita" id="visita" class="inpute">
                            <option value="">Selecione...</option>
                            <option value="sim">Sim</option>
                            <option value="nao">Não</option>
                        </select></p>

                    <div id="divpromocional">
                        <p><label for="codigoPromocional">Código Promocional</label>
                            <input id="codigoPromocional" name="codigoPromocional" title="Código Promocional" class="inpute" type="text" /></p>
                    </div>
        ...
        {?else?}
            ...
            <p>Seus dados foram registrados com sucesso. Para efetivar sua
                inscrição, imprima o boleto bancário e efetue o pagamento no Banco
                Banrisul ou em um terminal de auto-atendimento. Dentro de até 24 horas
